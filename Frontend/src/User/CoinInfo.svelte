<script>
    ...
    let coinName = '';
    onMount( () => {
        coinName = sessionStorage.getItem('expandCoin');
    })
...
<div class="gradient" style="min-height: 100vh;">
    <Navbar />
    <h1 style="font-family: 'Inter', sans-serif; text-align: left; margin-left: 2%;">{coinName}</h1>
    <div style="width: 60%; height: auto; align-self: center;">
