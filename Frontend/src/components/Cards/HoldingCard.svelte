<script>
    ...
    onMount(async () => {
      try {
        ...
        changeValue = (getRandomReal(0, 10)-5)*totalAssetValue/100;
        changeValue = changeValue.toFixed(5);
  ...
  <!-- Header -->
  <div class="relative md:ml-64 bg-red-500 pb-6 pt-12">
    <div class="px-4 md:px-10 mx-auto w-full">
      <div>
        <!-- Card stats -->
        <div class="flex flex-wrap">
          <div class="w-1/3 lg:w-1/3 xl:w-1/3 px-4">
            <CardStats
